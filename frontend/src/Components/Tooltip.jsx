...
const Tooltip = ({ className, infoText, children }) => {
    ...
    return (
        ...
        >
            ...
            <div className={ createClassName(`h-fit z-20 top-[-65px] text-wrap absolute w-[309px] rounded-8 px-8 py-12 text-body-s normal-case font-normal text-neutral-0 bg-neutral-900 text-center transition-all ease-in ${showTooltip ? "opacity-100" : "opacity-0"}`, className) }>
                { infoText }
