                    ...
                    <div className="w-full grid grid-cols-3 gap-16">
                        ...
                        >
                            ...
                            { cityList.map((city, cityIndex) => (
                                <DropdownItem
                                    key={ cityIndex }
                                    onClick={ () => handleProjectionChange(index, 'city', city.cityId) }
                                    className={ `flex hover:bg-neutral-100 rounded-8 px-12 py-8 cursor-pointer ${city.cityId === projection.city ? "font-semibold" : "font-normal"}` }
                                >
                                    { city.name }
                                </DropdownItem>
                            )) }
